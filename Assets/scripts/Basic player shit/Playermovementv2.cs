...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if ((rb.linearVelocity.y < 0 || stoppedJumping) && !grounded)
        {
            falling = true;
        }
        else if (grounded)
    ...
    public void Move(float direction, bool jump)
    {
        ...
        Vector2 targetVelocity = Vector2.zero;
            ...
            {
                MoveVelocity = Vector2.Lerp(MoveVelocity, targetVelocity, airAcceleration * Time.fixedDeltaTime);
    ...
    private void Fall()
    {
        Vector2 targetVelocity = new Vector2(rb.linearVelocity.x, Physics2D.gravity.y * fallMultiplier);
        rb.linearVelocity = Vector2.SmoothDamp(rb.linearVelocity, targetVelocity, ref refVelocity, fallSmoothing);
